...
- CAPTCHA 유형: 두 유형 모두 경유 지점을 지나 정답 보기를 드래그하는 방식이며, 문제를 아스키아트로 보여주는 방식만 다릅니다. 유형 1은 "바나나를 골라주세요"처럼 한글 지시문을 아스키아트로 보여주고 그 지시를 따르게 하며, 유형 2는 이미지를 아스키아트로 보여주고 그와 같은 대상을 4지선다 보기 중에서 고르게 합니다. 둘 다 드래그 궤적 검증으로 스크립트 봇을 탐지하며, 유형 1 실패(봇 의심도가 높을 때) 시 유형 2로 자동 전환됩니다.
